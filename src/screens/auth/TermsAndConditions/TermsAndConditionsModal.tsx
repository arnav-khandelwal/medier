  ...
  const content = (
    <View>
      <Text style={styles.firstParagraph}>
        Terms and conditions are the legal agreements between a service provider and a person who wants to use that service. These agreements can have many different titles, including:
      </Text>
